...
usable today. The Codex release this repo targets is **0.153.4** and the Cursor
release is **3.11** (changelog covered through 2026-09-02; desktop CLI observed at **3.18.9**): for each, the
...
**Cursor notes (3.11 → 2026-09-02).** Registration remains `.cursor/mcp.json` →
...
and records `desktop_cli` separately. Newest covered changelog date is **2026-09-02** (Self-Hosted Machines / Team Pools / partner sandboxes / computer use; prior subscriptions / custom modes / isolated subagent VMs / `/goal` / steering). Cursor also loads the open
